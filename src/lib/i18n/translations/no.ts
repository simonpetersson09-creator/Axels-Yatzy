...
export const no: typeof sv = {
  ...
  countrySection: 'Land',
  countryLabel: 'Land',
  countryNotSet: 'Ikke angitt',
  countryClear: 'Fjern land',
  goSettings: 'Innstillinger',
  settingsHint: 'Bytt språk og andre innstillinger her',
  ...
  adLoading: 'Laster reklame…',
  adFailed: 'Ingen reklame tilgjengelig nå.',
  ...
  // Head-to-head
  h2hTitle: 'Innbyrdes mot {name}',
  h2hMatches: 'Kamper',
  h2hWins: 'Seire',
  h2hLosses: 'Tap',
  h2hDraws: 'Uavgjort',
  h2hYourBest: 'Din beste',
  h2hAverage: 'Snitt',
  ...
  friendComparisonAhead: 'Du leder med {pct}% mot {name}',
  friendComparisonBehind: '{name} leder med {pct}% mot deg',
  friendComparisonEven: 'Dere er jevnbyrdige',
