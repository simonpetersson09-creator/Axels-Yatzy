...
export const da: typeof sv = {
  ...
  friendComparisonAhead: 'Du fører med {pct}% mod {name}',
  friendComparisonBehind: '{name} fører med {pct}% mod dig',
  friendComparisonEven: 'I er lige',
  ...
  maxActiveLocalGames: "Du har allerede {max} igangværende kampe mod computeren. Afslut én, før du starter en ny.",
