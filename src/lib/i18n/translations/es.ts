...
export const es: typeof sv = {
  ...
  opponent: 'oponente',
  opponents: 'oponentes',
  playWithFriends: 'Jugar con un amigo',
  friends: 'Amigos',
  statGames: 'Jugadas',
  statWins: 'Victorias',
  statHigh: 'Mejor',
  ...
  statYatzy: 'Yatzys',
  statStreak: 'Racha',
  worldRankLabel: 'Mundo',
  countryRankLabel: 'Tu ranking',
  countryRankLabelFull: 'Tu ranking en {country}',
  worldRankLabelFull: 'Tu ranking en el mundo',
  worldLeaderLabel: 'Líder mundial',
  countryRankIn: 'en',
  countryRankPlayers: 'jugadores',
  countrySection: 'País',
  countryLabel: 'País',
  ...
  friendsListReminder: 'Recuerda: es solo Yatzy. El divorcio es innecesario. 😄',
  myFriends: 'Mis amigos',
  friendsMatches: 'partidas',
  friendsTotalMatches: 'Partidas jugadas',
  ...
  friendComparisonAhead: 'Eres {pct}% mejor que {name}',
  friendComparisonBehind: '{name} es {pct}% mejor que tú',
  friendComparisonEven: 'Estáis empatados',
