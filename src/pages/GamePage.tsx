...
export default function GamePage() {
  ...
  return (
    <div
      className="h-[100dvh] max-h-[100dvh] px-2 sm:px-4 pt-7 pb-6 sm:py-6 safe-top safe-bottom flex items-start sm:items-center justify-center overflow-hidden overscroll-none touch-none"
