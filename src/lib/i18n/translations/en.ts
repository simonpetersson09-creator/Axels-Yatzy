...
export const en: typeof sv = {
  ...
  opponent: 'opponent',
  opponents: 'opponents',
  playWithFriends: 'Play with a friend',
  friends: 'Friends',
  statGames: 'Played',
  statWins: 'Wins',
  statHigh: 'Best',
  ...
  countryRankLabelFull: 'Your rank in {country}',
  worldRankLabelFull: 'Your rank in the world',
  worldLeaderLabel: 'World leader',
  countryRankIn: 'in',
  countryRankPlayers: 'players',
  countrySection: 'Country',
  countryLabel: 'Country',
  countryNotSet: 'Not set',
  countryClear: 'Clear country',
  goSettings: 'Settings',
  settingsHint: 'Change language and more settings here',
  ...
  // Head-to-head
  h2hTitle: 'Head-to-head vs {name}',
  h2hMatches: 'Matches',
  h2hWins: 'Wins',
  h2hLosses: 'Losses',
  h2hDraws: 'Draws',
  h2hYourBest: 'Your best',
  h2hAverage: 'Average',
  ...
  friendsListReminder: "Remember: it's only Yatzy. Divorce is unnecessary. 😄",
  myFriends: 'My friends',
  friendsMatches: 'matches',
  friendsTotalMatches: 'Matches played',
  friendsWins: 'Wins',
  ...
  friendComparisonAhead: 'You are {pct}% better than {name}',
  friendComparisonBehind: '{name} is {pct}% better than you',
  friendComparisonEven: 'You are evenly matched',
