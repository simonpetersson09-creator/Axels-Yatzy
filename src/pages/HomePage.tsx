                ...
                <AnimatePresence>
                  {showAdBubble && (
                    <motion.div
                      ...
                      className="absolute bottom-[calc(100%+6px)] right-0 z-50 w-[150px] sm:w-[180px] px-3 py-2.5 rounded-2xl bg-popover/95 border border-primary/30 shadow-[0_8px_28px_rgba(0,0,0,0.35)] backdrop-blur-sm cursor-pointer"
