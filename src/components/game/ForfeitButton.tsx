  ...
  return (
    <>
      <button
        ...
        className="relative inline-flex items-center justify-center gap-0.5 px-1.5 min-h-[32px] rounded-lg text-[11px] font-medium text-destructive/85 bg-destructive/10 border border-destructive/30 active:bg-destructive/20 transition-colors duration-200 whitespace-nowrap shadow-[0_2px_8px_-2px_hsl(0_0%_0%/0.4)]"
        style={{
